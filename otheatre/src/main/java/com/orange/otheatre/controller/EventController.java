...
//               userProfileRepository.saveAndFlush(userProfile); /*for testing only*/
                isEligible = eventService.isEligibileForReview(optionalUserProfile, event);
